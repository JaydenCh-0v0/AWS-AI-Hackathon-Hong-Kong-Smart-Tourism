...
export async function fetchHkoNineDay(lang = 'en') {
...
export function weatherAdviceFromSummary(summaryText) {
  ...
  if (rainy) return 'There may be rain; it is recommended to increase the proportion of indoor activities.';
  if (cloudy) return 'Cloudy, outdoor activities are feasible but pay attention to weather changes.';
  return 'Good weather, suitable for outdoor activities.';
}

...
async function loadItinerary(){
  ...
  window.currentSlots = allDaysSlots[currentDayIndex];
  renderSlotList(window.currentSlots);
  if(window.currentSlots.length > 0) renderStackForSlot(window.currentSlots[0]);
}
